...
Element.prototype.endElement = function(stack, nsName) {    
    if (this.nsName === nsName) {
        ...
        if (this !== stack[0]) {
            // Vadim: commented out extend for now as I see no reason of extending xmlns object by child xmlns
...
var UsingPolicyElement = Element.createSubClass();
...
var ElementTypeMap = {
    ...
    UsingPolicy : [UsingPolicyElement],
    Policy : [PolicyElement, 'Identity SupportedTokens SecurityToken UsePassword'],
    definitions: [DefinitionsElement, 'UsingPolicy Policy types message portType binding service']
};
...
DefinitionsElement.prototype.addChild = function(child) {
    ...
    else if (child instanceof UsingPolicyElement || child instanceof PolicyElement) {
        //do nothing with these two elements for now
    }
    else {
